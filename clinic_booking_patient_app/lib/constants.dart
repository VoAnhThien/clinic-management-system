...
class AppConstants {
  ...
  // Base API URL
  // Use 10.0.2.2 for Android Emulator, localhost for iOS simulator/Web, or custom IP
  static String apiBaseUrl = kIsWeb ? 'http://localhost:8080/api' : 'http://10.0.2.2:8080/api';
